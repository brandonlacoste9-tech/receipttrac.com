...
const BarcodeScanner = ({ onScanResult, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-[9999] flex items-center justify-center p-4">
      <div className="leather-card relative w-full max-w-md p-6 border-gold/40">
        <button 
          onClick={onClose}
        ...
        <h2 className="text-xl font-bold mb-6 flex items-center gap-3 uppercase tracking-widest text-gold/80" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
          <Camera size={20} /> VOUCHER BARCODE SCAN
        </h2>
        
        <div className="w-full bg-[#0a0a0a] rounded overflow-hidden border border-gold/10">
